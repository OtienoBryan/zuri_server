-- Create Merchandise Management System Tables
-- This script creates all necessary tables for merchandise management

-- Drop tables if they exist (in reverse order of dependencies)
DROP TABLE IF EXISTS merchandise_assignments;
DROP TABLE IF EXISTS merchandise_ledger;
DROP TABLE IF EXISTS merchandise_stock;
...
CREATE TABLE IF NOT EXISTS merchandise_stock (
    ...
    UNIQUE KEY unique_merchandise_store (merchandise_id, store_id, is_active)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DESCRIBE merchandise_categories;
DESCRIBE merchandise;
DESCRIBE merchandise_stock;
DESCRIBE merchandise_ledger;
DESCRIBE merchandise_assignments;
